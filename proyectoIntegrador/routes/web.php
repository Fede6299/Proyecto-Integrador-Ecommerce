...
Route::middleware(['auth'])->group(function (){
    Route::get('/administracion/dashboard',[PaginaController::class,'adminProductos']);
    ...
    Route::get('/administracion/dashboard/{producto}/editar-producto',[PaginaController::class,'editarProducto']);
